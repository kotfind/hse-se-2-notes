...
Пусть активность P состоит из операций a b c

Пусть активность Q состоит из операций d e f
...
Достаточные условия детерминированности набора

$W$ (от write) --- множество переменных, которые активность записывает

$R$ (от read) --- множество переменных, которые активность считывает
